...
// const ethersProvider = new ethers.Web3Provider('https://goerli.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161');
...
class Ladder extends LadderStore {
	...
	static async updateSearch(user: User, connection: Connection | null = null) {
		...
		for (const roomid of user.games) {
			...
			console.log('user.inRooms--->>>>>>>>>>>>>>>>>>>>>>', user.inRooms);
			...
			// 	from: '0x78Cf14D14CE9C31ae11986B848863064DAE0d4a2', // default from address
			// 	// gasPrice: '20000000000' // default gas price in wei, 20 gwei in this case
			// });

			// const contract = new ethers.ethers.Contract(contractAddress, abi, ethersProvider);
			...
			// let voucher = await lazyMinter.createBattle(user.walletAddress, user.walletAddress);
